...
const ChatForm = ({ setAnswer, setLoading, setChatID, setContent }) => {
            ...
            <form onSubmit={submitForm} className='mt-10'>
                ...
                <div className='flex flex-col mb-5'>
                    ...
                    <input
                        ...
                        required
                        aria-required="true"
                        onInvalid={(e) => e.target.setCustomValidity('Please enter the topic.')}
                ...
                <div className='flex flex-col mb-5'>
                    ...
                    <input
                        ...
                        required
                        aria-required="true"
                        onInvalid={(e) => e.target.setCustomValidity('Please enter the key of learning.')}
                        // Reset custom validity when the user interacts with the field again
                        onFocus={(e) => e.target.setCustomValidity('')}
                    />
                </div>
